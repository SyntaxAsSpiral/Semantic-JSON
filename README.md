...
- **Obsidian Canvas** becomes an full *WYSIWYG* authoring tool for this richly contextual JSON format, enhancing collaboration between human and machine intelligence.
