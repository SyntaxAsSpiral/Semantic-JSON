...
- 🔗 **Flow sort nodes** (default: disabled): Group nodes by directional flow topology instead of spatial position
- 🏠 **Semantic sort orphans** (default: disabled): Group orphan nodes first instead of spatial position
