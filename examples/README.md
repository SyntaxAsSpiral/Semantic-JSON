...
This folder contains [self-documenting examples](https://github.com/SyntaxAsSpiral/Collectivist) demonstrating Semantic JSON's anticompilation, import, and export features.
